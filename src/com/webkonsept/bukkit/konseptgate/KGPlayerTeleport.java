...
public class KGPlayerTeleport implements Runnable {
    ...
    public void run() {
        ...
        if (fromBlock != null && fromBlock.getType() == Material.STONE_PRESSURE_PLATE) {
            Powerable plateData = (Powerable) fromBlock.getBlockData();
            plateData.setPowered(false);
            fromBlock.setBlockData(plateData);
        }
    }
