...
public class KG extends JavaPlugin {
    ...
    protected Material underblock = Material.NETHER_BRICKS;
    ...
    private void loadConfig(){
        ...
        String underblockName = getConfig().getString("underblock", "NETHER_BRICKS");

        Material useUnderblock = Material.matchMaterial(underblockName);
        if (useUnderblock == null || !useUnderblock.isBlock()){
            problem("Invalid underblock in config, using NETHER_BRICKS");
            this.underblock = Material.NETHER_BRICKS;
        }
        else {
            this.underblock = useUnderblock;
            verbose("underblock is "+underblock.toString());
        }
